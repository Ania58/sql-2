...
UPDATE usuarios SET id_categoria = 3 WHERE id_usuario IN (3);
UPDATE usuarios SET id_categoria = 4 WHERE id_usuario IN (6,7);
UPDATE usuarios SET id_categoria = 5 WHERE id_usuario IN (8,10,11);
UPDATE usuarios SET id_categoria = 6 WHERE id_usuario IN (12);
UPDATE usuarios SET id_categoria = 7 WHERE id_usuario IN (15);
UPDATE usuarios SET id_categoria = 8 WHERE id_usuario IN (14,16);
UPDATE usuarios SET id_categoria = 9 WHERE id_usuario IN (18);
